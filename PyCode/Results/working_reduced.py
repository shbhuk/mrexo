...
def MLE_fit_bootstrap(data, sigma, Mass_max = None, Mass_min = None, Radius_max = None, Radius_min = None, degree = 60, select_deg = 55,
    ...
    copyfile(os.path.join(os.path.dirname(location),'working_reduced.py'), os.path.join(location,'working_reduced.py'))
    copyfile(os.path.join(os.path.dirname(location),'MLE_fit_reduced.py'), os.path.join(location,'MLE_fit_reduced.py'))
...
if __name__ == '__main__':           
    a = MLE_fit_bootstrap(data = data, sigma = sigma, Mass_max = Mass_max, 
                        ...
                        location = os.path.join(os.path.dirname(__file__),'Bootstrap_results_lower_prec'))
